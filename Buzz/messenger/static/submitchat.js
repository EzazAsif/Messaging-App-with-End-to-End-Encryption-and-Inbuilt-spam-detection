document.getElementById("comment").addEventListener("keydown", function(event) {
  if (event.key === "Enter" && !event.shiftKey) {  // Check if Enter is pressed without Shift for a newline
      event.preventDefault();  // Prevent newline
      document.getElementById("attachmentForm").requestSubmit();  // Trigger form submission
  }
});
